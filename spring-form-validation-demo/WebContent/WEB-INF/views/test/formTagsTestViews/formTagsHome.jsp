			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<form:checkbox path="promotionServices" value="promotionServices"/> ${subscriptionList.promotionServices}
						<form:checkbox path="newsLetterServices" value="newsLetterServices"/> ${subscriptionList.newsLetterServices}
					</td>
				</tr>
				<tr>
