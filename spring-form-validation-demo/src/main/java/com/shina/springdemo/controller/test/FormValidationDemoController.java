...
import com.shina.springdemo.domain.test.OrganizationRepresentative;
...
public class FormValidationDemoController {
	...
	public String organizationRepresentative(@Valid @ModelAttribute("orgrep")OrganizationRepresentative orgRepresentative,
